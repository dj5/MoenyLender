 ...
 */
public class AgentClient extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_agent_client, container, false);



        search=v.findViewById(R.id.AgentClientSearch);
        ...
        adapter= new AgentAdapter(userList, Objects.requireNonNull(getActivity()).getSupportFragmentManager(),"AgentClient");

        recyclerView=v.findViewById(R.id.AgentClientRecycleList);
