 ...
 */
public class ActiveCustCollectionFragment extends Fragment {
    ...
    public ActiveCustCollectionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_active_cust_collection, container, false);
        ...
        search = v.findViewById(R.id.ActiveCustSearch);

        adapter = new CustAdapter(userList, Objects.requireNonNull(getActivity()).getSupportFragmentManager(), "ActiveCustCollection");

        recyclerView = v.findViewById(R.id.ActiveAgentRecycleList);
