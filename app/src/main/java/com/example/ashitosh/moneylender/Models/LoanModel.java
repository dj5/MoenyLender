...
public class LoanModel {
   ...
   private String AgentEmail,Status,AgentName,DOI,DOR,ExpectedInstallment,FiledAmount,Interest,LoanType,ReqAmount,AmountToReturn,PendingAmount,LoanId,LFNO,Discount;
    ...
    public LoanModel(String agentEmail) {
